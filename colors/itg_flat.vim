...
hi CursorLine	    guifg=#e4e4e4    ctermfg=254    guibg=#30323b    ctermbg=237    gui=none    cterm=none
...
hi NonText	    	guibg=#282a31    ctermbg=235    guifg=#d1605e    ctermfg=167    gui=none    cterm=none
...
hi StatusLine	    guibg=#30323b    ctermbg=07    	guifg=#e0e0e0    ctermfg=231    gui=none    cterm=none
hi StatusLineNC	    guibg=#30323b    ctermbg=06    	guifg=#777777    ctermfg=230    gui=none    cterm=none
...
hi VertSplit	    guibg=#282a31    ctermbg=236    guifg=#585858    ctermfg=240    gui=none    cterm=none
